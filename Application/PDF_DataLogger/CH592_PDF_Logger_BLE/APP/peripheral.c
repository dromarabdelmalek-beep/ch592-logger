 ...
 * Version            : V1.0
 * Date               : 2018/12/10
 * Description        : Peripheral application program, initializes broadcast connection parameters,
 *                      then broadcasts and starts advertising, after successful connection,
 *                      custom services can be used for communication
 *********************************************************************************
